(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@onflow/config'), require('@onflow/util-invariant'), require('@onflow/sdk'), require('@onflow/types'), require('@onflow/util-actor'), require('@onflow/util-address'), require('@onflow/rlp'), require('@onflow/util-uid'), require('@onflow/util-template')) :
  typeof define === 'function' && define.amd ? define(['exports', '@onflow/config', '@onflow/util-invariant', '@onflow/sdk', '@onflow/types', '@onflow/util-actor', '@onflow/util-address', '@onflow/rlp', '@onflow/util-uid', '@onflow/util-template'], factory) :
  (global = global || self, factory(global.fcl = {}, global.config$1, global.utilInvariant, global.sdk, global.t$1, global.utilActor, global.utilAddress, global.rlp, global.utilUid, global.utilTemplate));
})(this, (function (exports, config$1, utilInvariant, sdk, t$1, utilActor, utilAddress, rlp, utilUid, utilTemplate) {
