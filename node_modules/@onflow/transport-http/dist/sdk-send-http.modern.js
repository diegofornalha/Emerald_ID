...
async function sendExecuteScript(ix, context = {}, opts = {}) {
...
async function sendGetAccountAtLatestBlockRequest(ix, context, opts) {
  ...
  const httpRequest$1 = opts.httpRequest || httpRequest;
  const height = (_ix$block = ix.block) != null && _ix$block.isSealed ? "sealed" : "final";
  const res = await httpRequest$1({
    hostname: opts.node,
...
async function sendGetAccount(ix, context = {}, opts = {}) {
...
async function sendGetLatestBlockHeaderRequest(ix, context, opts) {
  ...
  const httpRequest$1 = opts.httpRequest || httpRequest;
  const height = (_ix$block = ix.block) != null && _ix$block.isSealed ? "sealed" : "finalized";
  const res = await httpRequest$1({
    hostname: opts.node,
...
async function sendGetBlockHeader(ix, context = {}, opts = {}) {
...
async function sendGetBlock(ix, context = {}, opts = {}) {
...
async function sendGetCollection(ix, context = {}, opts = {}) {
...
async function sendGetEvents(ix, context = {}, opts = {}) {
...
async function sendGetTransaction(ix, context = {}, opts = {}) {
...
async function sendGetTransactionStatus(ix, context = {}, opts = {}) {
  ...
  ret.transactionStatus = {
    ...
    statusCode: 0,
    // TODO: Use field when it becomes available on HTTP Access API
...
async function sendPing(ix, context = {}, opts = {}) {
...
async function sendTransaction(ix, context = {}, opts = {}) {
  ...
  const httpRequest$1 = opts.httpRequest || httpRequest;
  ix = await ix; // Apply Non Payer Signatures to Payload Signatures
...
const send = async (ix, context = {}, opts = {}) => {
...
//# sourceMappingURL=sdk-send-http.modern.js.map
